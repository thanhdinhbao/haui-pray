    ...
    return function(h) {
        ...
        var s = Object.assign || function(o) {
            ...
            E = function() {
                ...
                if (o && (F = !0), F) return S = (0, G.default)(S, v), (0, I.default)(S, v.once), S
            },
            P = function() {
                S = (0, B.default)(), E()
            };
        h.exports = {
            init: function(o) {
                ...
                return function(o) {
                    ...
                    E(!0)
                }), window.addEventListener("resize", (0, a.default)(E, v.debounceDelay, !0)), window.addEventListener("orientationchange", (0, a.default)(E, v.debounceDelay, !0)), window.addEventListener("scroll", (0, i.default)(function() {
                    (0, I.default)(S, v.once)
                }, v.throttleDelay)), v.disableMutationObserver || c.default.ready("[data-aos]", P), S)
            },
            refresh: E,
            refreshHard: P
        }
    }, function(h, u) {}, , , , , function(h, u) {
        (function(r) {
            "use strict";
            ...
            h.exports = function(t, d, o) {
                ...
                return b(o) && (x = "leading" in o ? !!o.leading : x, A = "trailing" in o ? !!o.trailing : A),
                    function(t, d, o) {
                        function x(l) {
                            var O = z,
                                W = T;
                        ...
                        var z, T, q, k, g, _, H = 0,
                            ...
                            y = !0;
                        if ("function" != typeof t) throw new TypeError(f);
                        return d = p(d) || 0, b(o) && ($ = !!o.leading, q = (L = "maxWait" in o) ? E(p(o.maxWait) || 0, d) : q, y = "trailing" in o ? !!o.trailing : y), N.cancel = function() {
                            void 0 !== g && clearTimeout(g), H = 0, z = _ = T = g = void 0
                        }, N.flush = function() {
        ...
        (function(r) {
            ...
            h.exports = function(e, t, d) {
                ...
                return t = i(t) || 0, s(d) && (H = !!d.leading, T = ($ = "maxWait" in d) ? v(i(d.maxWait) || 0, t) : T, L = "trailing" in d ? !!d.trailing : L), Q.cancel = function() {
                    void 0 !== k && clearTimeout(k), _ = 0, N = g = z = k = void 0
                }, Q.flush = function() {
        ...
        function r(p) {
            ...
            for (a = 0; a < p.length; a += 1)
                if ((f = p[a]).dataset && f.dataset.aos || f.children && r(f.children)) return !0;
            return !1
        }
        ...
        u.default = {
            ...
            ready: function(p, a) {
                var f = window.document,
                    m = new(n())(w);
                i = a, m.observe(f.documentElement, {
                    childList: !0,
                    subtree: !0,
                    removedNodes: !0
                })
        ...
        u.default = function(i, p) {
            ...
            switch (m.offset && !isNaN(m.offset) && (f = parseInt(m.offset)), m.anchor && document.querySelectorAll(m.anchor) && (i = document.querySelectorAll(m.anchor)[0]), a = (0, b.default)(i).top, m.anchorPlacement) {
                case "top-bottom":
                    break;
                case "center-bottom":
                    a += i.offsetHeight / 2;
        ...
        Object.defineProperty(u, "__esModule", {
            ...
            for (var s = 0, b = 0; n && !isNaN(n.offsetLeft) && !isNaN(n.offsetTop);) s += n.offsetLeft - ("BODY" != n.tagName ? n.scrollLeft : 0), b += n.offsetTop - ("BODY" != n.tagName ? n.scrollTop : 0), n = n.offsetParent;
            return {
                top: b,
                left: s
            }
